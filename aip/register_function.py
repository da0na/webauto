# coding=utf-8
import sys
sys.path.append('/Users/daona/PycharmProjects/webauto')
...
class RegisterFunction(object):
    ...
    def main(self):
        ...
        file_name = r"/Users/daona/PycharmProjects/webauto/test03.png"
        ...
        # self.send_user_info('code_text', '1111')
        self.get_user_element('register_button').click()
        code_error = self.get_user_element('code_text_error')
        if code_error == None:
            print("注册成功")
        else:
            self.driver.save_screenshot("/Users/daona/PycharmProjects/webauto/code_error.png")
        time.sleep(10)
        self.driver.close()
